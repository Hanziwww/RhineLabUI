---
{
  "id": "congenital-hearing-loss",
  "number": 14,
  "title": "congenital hearing loss",
  "subtitle": "CONGENITAL HEARING LOSS",
  "column": "genetics",
  "tags": [
    "IEKB",
    "known database"
  ...
  "dataKey": "congenital-hearing-loss"
}
---

## About this topic

This archive brings together IEKB records indexed under **congenital hearing loss**. The topic name follows the source release's normalized phenotype vocabulary. Original phenotypes and disease names remain available with each record.
