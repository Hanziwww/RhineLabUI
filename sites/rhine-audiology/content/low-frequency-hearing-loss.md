---
{
  "id": "low-frequency-hearing-loss",
  "number": 4,
  "title": "low-frequency hearing loss",
  "subtitle": "LOW-FREQUENCY HEARING LOSS",
  "column": "auditory",
  "tags": [
    "IEKB",
    "known database"
  ...
  "dataKey": "low-frequency-hearing-loss"
}
---

## About this topic

This archive brings together IEKB records indexed under **low-frequency hearing loss**. The topic name follows the source release's normalized phenotype vocabulary. Original phenotypes and disease names remain available with each record.
