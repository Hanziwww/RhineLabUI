---
{
  "id": "progressive-sensorineural-hearing-loss",
  "number": 8,
  "title": "progressive sensorineural hearing loss",
  "subtitle": "PROGRESSIVE SENSORINEURAL HEARING LOSS",
  "column": "auditory",
  "tags": [
    "IEKB",
    "known database"
  ...
  "dataKey": "progressive-sensorineural-hearing-loss"
}
---

## About this topic

This archive brings together IEKB records indexed under **progressive sensorineural hearing loss**. The topic name follows the source release's normalized phenotype vocabulary. Original phenotypes and disease names remain available with each record.
