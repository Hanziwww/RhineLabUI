---
{
  "id": "severe-hearing-loss",
  "number": 10,
  "title": "severe hearing loss",
  "subtitle": "SEVERE HEARING LOSS",
  "column": "auditory",
  "tags": [
    "IEKB",
    "known database"
  ...
  "dataKey": "severe-hearing-loss"
}
---

## About this topic

This archive brings together IEKB records indexed under **severe hearing loss**. The topic name follows the source release's normalized phenotype vocabulary. Original phenotypes and disease names remain available with each record.
