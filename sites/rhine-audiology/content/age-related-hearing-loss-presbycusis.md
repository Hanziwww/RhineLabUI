---
{
  "id": "age-related-hearing-loss-presbycusis",
  "number": 21,
  "title": "age-related hearing loss (presbycusis)",
  "subtitle": "AGE-RELATED HEARING LOSS (PRESBYCUSIS)",
  "column": "injury",
  "tags": [
    "IEKB",
    "known database"
  ...
  "dataKey": "age-related-hearing-loss-presbycusis"
}
---

## About this topic

This archive brings together IEKB records indexed under **age-related hearing loss (presbycusis)**. The topic name follows the source release's normalized phenotype vocabulary. Original phenotypes and disease names remain available with each record.
