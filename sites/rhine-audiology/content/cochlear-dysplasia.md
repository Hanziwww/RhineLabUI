---
{
  "id": "cochlear-dysplasia",
  "number": 13,
  "title": "cochlear dysplasia",
  "subtitle": "COCHLEAR DYSPLASIA",
  "column": "genetics",
  "tags": [
    "IEKB",
    "known database"
  ...
  "dataKey": "cochlear-dysplasia"
}
---

## About this topic

This archive brings together IEKB records indexed under **cochlear dysplasia**. The topic name follows the source release's normalized phenotype vocabulary. Original phenotypes and disease names remain available with each record.
