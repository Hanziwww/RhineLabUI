---
{
  "id": "vestibular-dysfunction",
  "number": 43,
  "title": "vestibular dysfunction",
  "subtitle": "VESTIBULAR DYSFUNCTION",
  "column": "vestibular",
  "tags": [
    "IEKB",
    "known database"
  ...
  "dataKey": "vestibular-dysfunction"
}
---

## About this topic

This archive brings together IEKB records indexed under **vestibular dysfunction**. The topic name follows the source release's normalized phenotype vocabulary. Original phenotypes and disease names remain available with each record.
