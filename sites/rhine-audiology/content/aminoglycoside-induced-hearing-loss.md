---
{
  "id": "aminoglycoside-induced-hearing-loss",
  "number": 22,
  "title": "aminoglycoside-induced hearing loss",
  "subtitle": "AMINOGLYCOSIDE-INDUCED HEARING LOSS",
  "column": "injury",
  "tags": [
    "IEKB",
    "known database"
  ...
  "dataKey": "aminoglycoside-induced-hearing-loss"
}
---

## About this topic

This archive brings together IEKB records indexed under **aminoglycoside-induced hearing loss**. The topic name follows the source release's normalized phenotype vocabulary. Original phenotypes and disease names remain available with each record.
