---
{
  "id": "normal-inner-ear-function",
  "number": 34,
  "title": "normal inner ear function",
  "subtitle": "NORMAL INNER EAR FUNCTION",
  "column": "cellular",
  "tags": [
    "IEKB",
    "known database"
  ...
  "dataKey": "normal-inner-ear-function"
}
---

## About this topic

This archive brings together IEKB records indexed under **normal inner ear function**. The topic name follows the source release's normalized phenotype vocabulary. Original phenotypes and disease names remain available with each record.
