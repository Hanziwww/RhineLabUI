---
{
  ...
  "subtitle": "VESTIBULAR SCHWANNOMA",
  "column": "vestibular",
  "tags": [
    "IEKB",
    "known database"
  ...
  "dataKey": "vestibular-schwannoma"
}
---

## About this topic

This archive brings together IEKB records indexed under **vestibular schwannoma**. The topic name follows the source release's normalized phenotype vocabulary. Original phenotypes and disease names remain available with each record.
