---
{
  "id": "syndromic-hearing-loss",
  "number": 20,
  "title": "syndromic hearing loss",
  "subtitle": "SYNDROMIC HEARING LOSS",
  "column": "genetics",
  "tags": [
    "IEKB",
    "known database"
  ...
  "dataKey": "syndromic-hearing-loss"
}
---

## About this topic

This archive brings together IEKB records indexed under **syndromic hearing loss**. The topic name follows the source release's normalized phenotype vocabulary. Original phenotypes and disease names remain available with each record.
