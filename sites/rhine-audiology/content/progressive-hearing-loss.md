---
{
  "id": "progressive-hearing-loss",
  "number": 7,
  "title": "progressive hearing loss",
  "subtitle": "PROGRESSIVE HEARING LOSS",
  "column": "auditory",
  "tags": [
    "IEKB",
    "known database"
  ...
  "dataKey": "progressive-hearing-loss"
}
---

## About this topic

This archive brings together IEKB records indexed under **progressive hearing loss**. The topic name follows the source release's normalized phenotype vocabulary. Original phenotypes and disease names remain available with each record.
