---
{
  "id": "genetic-hearing-loss",
  "number": 15,
  "title": "genetic hearing loss",
  "subtitle": "GENETIC HEARING LOSS",
  "column": "genetics",
  "tags": [
    "IEKB",
    "known database"
  ...
  "dataKey": "genetic-hearing-loss"
}
---

## About this topic

This archive brings together IEKB records indexed under **genetic hearing loss**. The topic name follows the source release's normalized phenotype vocabulary. Original phenotypes and disease names remain available with each record.
