---
{
  ...
  "dataKey": "endolymphatic-hydrops"
}
---

## About this topic

This archive brings together IEKB records indexed under **endolymphatic hydrops**. The topic name follows the source release's normalized phenotype vocabulary. Original phenotypes and disease names remain available with each record.
